...
function render() {
  switch (state.scene) {
    ...
    case "brian": renderStoryDialogue(["brian-player.webp", "brian-reply.webp"], "", [["PLAYER", `“Hey Brian, I’m gonna be a BASE jumper.”`], ["BRIAN", `“Hey, ${escapeHtml(state.name || "mate")}. Nobody cares.”`]], "dave"); break;
    case "dave": renderStoryDialogue(["dave-player.webp", "dave-reply.webp"], "WORK", [["PLAYER", `“Hey Dave, I got that report finished by one. Guess what? I’m going to be a BASE jumper.”`], ["DAVE", `“Hey, ${escapeHtml(state.name || "mate")}. Couldn’t give a shit. Get back to work.”`]], "parents"); break;
    case "parents": renderStoryDialogue(["parents-player-call.webp", "parents-reply.webp", "parents-player-angry.webp"], "", [["PLAYER", `“Hey, Mom and Dad, guess what? I’m going to train as a BASE jumper.”`], ["PARENTS", `“But, ${escapeHtml(state.name || "love")}, what about the law degree we paid for?”`], ["PLAYER", `“Stop trying to control me. I’m a BASE jumper now.”`]], "wife-promise"); break;
    case "wife-promise": renderStoryDialogue(["wife-announcement.webp", "wife-concern.webp", "wife-promise-hurt.webp", "wife-promise-careful.webp", "wife-promise-died.webp", "wife-promise-slow.webp", "wife-promise-skydiving.webp", "wife-promise-good-people.webp", "wife-promise-party.webp", "wife-promise-stop.webp"], "HOME", [["PLAYER", `“Hey everyone, guess what? I’m going to be a BASE jumper.”`], ["WIFE", `“What do you mean? That sounds incredibly dangerous. What if you get killed? You’ve got a wife and children to support.”`], ["PLAYER", `“I won’t get hurt.”`], ["PLAYER", `“I’ll be really careful.”`], ["PLAYER", `“I won’t make the same mistakes as everyone else who has died.”`], ["PLAYER", `“I won’t rush my progression.”`], ["PLAYER", `“I’ll do lots of skydiving to build up my experience level.”`], ["PLAYER", `“I’ll only jump with good people.”`], ["PLAYER", `“I’ll avoid drinking and partying and other temptations like girls and drugs.”`], ["PLAYER", `“I’ll just do it for a little while, and then I’ll stop.”`]], "first-choice"); break;
